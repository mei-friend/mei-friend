...
export const lang = {
  ...
  showLinkedElements: {
    text: 'Mostra elements enllaçats',
    description: "Ressalta els elements referenciats per l'element seleccionat (p. ex. startid/endid/plist) a l'editor i la notació",
  },
  showTrailingSpace: {
  ...
  letsEncodeSaveButton: { text: 'Desa' },
