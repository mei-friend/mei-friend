...
updateControlsLabel: { text: 'Opdater', description: 'Kontroller opdateringsopførsel af notation efter ændringer i kodning' },
...
speedLabel: {
  text: 'Hastigheds mode',
    description: 'I hastigheds mode sendes kun den nuværende side til Verovio for at reducere render tid med store filer',
  },
...
forkRepoGithubExplanation: {
  text:
  'Linket du har fulgt ' +
    'vil oprette en GitHub fork af følgende repository til redigering i mei-friend:',
  },
...
midiSpeedmodeIndicator: {
  text: 'Hastigheds mode',
    description: 'Hastigheds mode er aktiv; kun afspilning af MIDI for nuværende side. For at afspille hele kodningen, deaktiver hastigheds mode.',
  },
...
transposeInterval: {
  text: 'Transponer ved interval',
    description: 'Transponer kodning ved kromatisk interval ved de mest almindelige intervaller (Verovio understøtter base-40 systemet)',
      labels: [
        'Perfekt unison',
        'Forstørret unison',
        'Formindsket sekund',
...
transposeButton: {
  text: 'Transponer',
    description: 'Anvend transponering med ovenstående indstillinger på notationen, mens MEI-kodningen forbliver uændret. For også at transponere MEI-kodningen med de nuværende indstillinger, brug "Genrender via Verovio" i "Manipuler" dropdown-menuen.',
  },
