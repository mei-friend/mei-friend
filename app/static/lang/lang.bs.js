...
export const lang = {
  ...
  missingIdsWarningAlertOnLoading: {
    text: 'Postoji najmanje jedan markup element unutar nadređenog elementa bez xml:id. mei-friend ne može obraditi markup u datotekama bez ID-ova. Molimo dodajte ID-ove u kodiranje.'
  },  
};
