...
export const lang = {
  ...
  addSupplied: { text: 'Ausgewählte Elemente' },
  addSuppliedArticText: { text: 'Artikulation' },
  addSuppliedAccidText: { text: 'Vorzeichen' },
  addUnclearText: { text: '<unclear>' },
  addUnclear: { text: 'Ausgewählte Elemente' },
  addUnclearArticText: { text: 'Artikulation' },
  addUnclearAccidText: { text: 'Vorzeichen' },
  addSicText: { text: '<sic>' },
  addSic: { text: 'Ausgewählte Elemente' },
  addSicArticText: { text: 'Artikulation' },
  addSicAccidText: { text: 'Vorzeichen' },
  addCorrText: { text: '<corr>' },
  addCorr: { text: 'Ausgewählte Elemente' },
  addCorrArticText: { text: 'Artikulation' },
  addCorrAccidText: { text: 'Vorzeichen' },
  addOrigText: { text: '<orig>' },
  addOrig: { text: 'Ausgewählte Elemente' },
  addOrigArticText: { text: 'Artikulation' },
  addOrigAccidText: { text: 'Vorzeichen' },
  addRegText: { text: '<reg>' },
  addReg: { text: 'Ausgewählte Elemente' },
  addRegArticText: { text: 'Artikulation' },
  addRegAccidText: { text: 'Vorzeichen' },
  addAddText: { text: '<add>' },
  addAdd: { text: 'Ausgewählte Elemente' },
  addAddArticText: { text: 'Artikulation' },
  addAddAccidText: { text: 'Vorzeichen' },
  addDelText: { text: '<del>' },
  addDel: { text: 'Ausgewählte Elemente' },
  addDelArticText: { text: 'Artikulation' },
  addDelAccidText: { text: 'Vorzeichen' },
