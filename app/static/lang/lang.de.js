...
export const lang = {
  ...
  addSuppliedArtic: { text: 'Artikulation' },
  addSuppliedAccid: { text: 'Vorzeichen' },
  addUnclearText: { text: '<unclear>' },
  addUnclear: { text: 'Ausgewählte Elemente' },
  addUnclearArtic: { text: 'Artikulation' },
  addUnclearAccid: { text: 'Vorzeichen' },
  addSicText: { text: '<sic>' },
  addSic: { text: 'Ausgewählte Elemente' },
  addSicArtic: { text: 'Artikulation' },
  addSicAccid: { text: 'Vorzeichen' },
  addCorrText: { text: '<corr>' },
  addCorr: { text: 'Ausgewählte Elemente' },
  addCorrArtic: { text: 'Artikulation' },
  addCorrAccid: { text: 'Vorzeichen' },
  addOrigText: { text: '<orig>' },
  addOrig: { text: 'Ausgewählte Elemente' },
  addOrigArtic: { text: 'Artikulation' },
  addOrigAccid: { text: 'Vorzeichen' },
  addRegText: { text: '<reg>' },
  addReg: { text: 'Ausgewählte Elemente' },
  addRegArtic: { text: 'Artikulation' },
  addRegAccid: { text: 'Vorzeichen' },
  addAddText: { text: '<add>' },
  addAdd: { text: 'Ausgewählte Elemente' },
  addAddArtic: { text: 'Artikulation' },
  addAddAccid: { text: 'Vorzeichen' },
  addDelText: { text: '<del>' },
  addDel: { text: 'Ausgewählte Elemente' },
  addDelArtic: { text: 'Artikulation' },
  addDelAccid: { text: 'Vorzeichen' },
