...
export const lang = {
  ...
  letsEncodeLoggedInAs: { text: 'Logged in as' },
  letsEncodeSaveButton: { value: 'Save' },
  letsEncodeSaving: { text: 'Saving your work…' },
  letsEncodeSaveFailed: { text: 'Your work could not be saved.' },
  letsEncodeDismiss: { value: 'Dismiss' },
  letsEncodeLastSave: { text: 'Last save:' },
  letsEncodeLastAutosave: { text: 'Autosaved:' },
  ...
  loadFileError: { text: 'Sorry, could not read file from repository' },
  ...
  accidGesCodeCheckerTitle: {
    text: 'Checking @accid.ges attributes (against key signature, measure-wise accids, and ties).',
  },
  metConCodeCheckerTitle: {
    text: 'Checking meter conformance (at least one layer per staff has beat number given in meter signature).',
  },
  ...
  codeCheckerMeterConformanceMessage: { text: 'All measures conform to their time signatures.' },
  codeCheckerMeasure: { text: 'Measure' },
  codeCheckerStaff: { text: 'Staff' },
  codeCheckerNote: { text: 'Note' },
  codeCheckerHasBoth: { text: 'has both' },
  codeCheckerAnd: { text: 'and' },
  codeCheckerHasADurationOf: { text: 'has a duration of' },
  codeCheckerInsteadOf: { text: 'instead of' },
