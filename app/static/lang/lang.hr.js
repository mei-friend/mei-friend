...
export const lang = {
  ...
  addSuppliedText: {
    text: 'Ispravka',
    description: 'Sadrži materijal koji je dodao prepisivač ili urednik iz bilo kog razloga.',
  },
  ...
  rangedAnnotationInvalidSelection: {
    ...
    text2:
      'Molimo vas da dodelite identifikatore tako što ćete izabrati "Manipulacija" -> "Dodaj ID-ove MEI" i pokušati ponovo.',
  },
  ...
  selectionSelect: {
    ...
    description:
      'Izaberite da li novokreirano obeležavanje treba da obuhvati izabrane elemente, artikulaciju ili predznake',
