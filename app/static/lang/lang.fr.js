...
export const lang = {
  ...
  addSuppliedArtic: { text: 'Articulation' },
  addSuppliedAccid: { text: 'Accidentel' },
  addUnclearText: { text: '<unclear>' },
  addUnclear: { text: 'Éléments sélectionnés' },
  addUnclearArtic: { text: 'Articulation' },
  addUnclearAccid: { text: 'Accidentel' },
  addSicText: { text: '<sic>' },
  addSic: { text: 'Éléments sélectionnés' },
  addSicArtic: { text: 'Articulation' },
  addSicAccid: { text: 'Accidentel' },
  addCorrText: { text: '<corr>' },
  addCorr: { text: 'Éléments sélectionnés' },
  addCorrArtic: { text: 'Articulation' },
  addCorrAccid: { text: 'Accidentel' },
  addOrigText: { text: '<orig>' },
  addOrig: { text: 'Éléments sélectionnés' },
  addOrigArtic: { text: 'Articulation' },
  addOrigAccid: { text: 'Accidentel' },
  addRegText: { text: '<reg>' },
  addReg: { text: 'Éléments sélectionnés' },
  addRegArtic: { text: 'Articulation' },
  addRegAccid: { text: 'Accidentel' },
  addAddText: { text: '<add>' },
  addAdd: { text: 'Éléments sélectionnés' },
  addAddArtic: { text: 'Articulation' },
  addAddAccid: { text: 'Accidentel' },
  addDelText: { text: '<del>' },
  addDel: { text: 'Éléments sélectionnés' },
  addDelArtic: { text: 'Articulation' },
  addDelAccid: { text: 'Accidentel' },
