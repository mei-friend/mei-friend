...
export const lang = {
  ...
  splashBody: {
    html: `
    <p>
      mei-friend è un editor per <a href="https://music-encoding.org">codifiche musicali</a>, ospitato presso
      l'<a href="https://mdw.ac.at" target="_blank">Università di Musica e Arti dello Spettacolo di Vienna</a>. Si
      prega di consultare la nostra <a href="https://mei-friend.github.io" target="_blank">documentazione completa</a>
      per ulteriori informazioni.
    </p>
    <p>
      Anche se mei-friend è un'applicazione basata su browser, nessuno dei tuoi dati personali (compresa la codifica
      che stai modificando, le impostazioni dell'applicazione e i dettagli di accesso attuali, se presenti) viene
      memorizzato sui nostri server; invece, sono memorizzati nel
      <a href="https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage" target="_blank">localStorage</a>
      del tuo browser.
    </p>
    <p>
      I dati vengono trasmessi a GitHub solo quando lo richiedi esplicitamente (ad esempio, quando effettui il login
      su GitHub, carichi la tua codifica da un repository GitHub o richiedi l'esecuzione di un flusso di lavoro GitHub
      Action). Allo stesso modo, i dati vengono trasmessi al tuo provider Solid scelto solo quando lo richiedi
      esplicitamente (ad esempio, quando effettui il login su Solid o carichi/salvi annotazioni stand-off).
    </p>
    <p>
      Utilizziamo <a href="https://matomo.org/" target="_blank">Matomo</a> per raccogliere statistiche di utilizzo
      anonime. Queste includono il tuo indirizzo IP troncato (consentendo la geolocalizzazione solo a livello di paese,
      ma nessuna ulteriore identificazione), il tuo browser e sistema operativo, da dove sei arrivato (ovvero il sito
      web di provenienza), l'orario e la durata della tua visita e le pagine che hai visitato. Queste informazioni
      sono memorizzate sull'istanza di Matomo in esecuzione sui server dell'Università di Musica e Arti dello Spettacolo
      di Vienna e non sono condivise con terze parti.
    </p>
    <p>
      Infine, la riproduzione MIDI viene presentata utilizzando il font sonoro SGM_plus fornito da Google Magenta e
      servito tramite googleapis.com. Il tuo indirizzo IP viene trasmesso a Google per questo scopo. Se non desideri
    ...
    <p>
      ...
      <a href="https://iwk.mdw.ac.at/david-weigl" target="_blank">David M. Weigl</a> presso il Dipartimento di
      Acustica Musicale - Wiener Klangstil dell'Università di Musica e Arti dello Spettacolo di Vienna (mdw) ed è
      concesso in licenza con la
      <a href="https://spdx.org/licenses/AGPL-3.0-or-later.html" target="_blank">GNU Affero General Public License
      v3.0</a>. Si prega di consultare la nostra <a href="https://mei-friend.github.io/about/" target="_blank">pagina
      dei ringraziamenti</a> per ulteriori informazioni sui contributori e sui componenti open source riutilizzati nel
      nostro progetto. Ringraziamo i nostri colleghi per il loro contributo e la loro guida.
    </p>
    <p>
      Lo sviluppo dell'applicazione Web mei-friend è finanziato dalla
      <a href="https://fwf.ac.at" target="_blank">Fondazione Austriaca per la Ricerca Scientifica (FWF)</a> nei
      progetti
