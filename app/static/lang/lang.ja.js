...
export const lang = {
  ...
  addSuppliedArtic: { text: '発音' },
  addSuppliedAccid: { text: '偶然' },
  addUnclearText: { text: '<unclear>' },
  addUnclear: { text: '選択された要素' },
  addUnclearArtic: { text: '発音' },
  addUnclearAccid: { text: '偶然' },
  addSicText: { text: '<sic>' },
  addSic: { text: '選択された要素' },
  addSicArtic: { text: '発音' },
  addSicAccid: { text: '偶然' },
  ...
  addCorrArtic: { text: '発音' },
  addCorrAccid: { text: '偶然' },
  addOrigText: { text: '<orig>' },
  addOrig: { text: '選択された要素' },
  addOrigArtic: { text: '発音' },
  addOrigAccid: { text: '偶然' },
  addRegText: { text: '<reg>' },
  addReg: { text: '選択された要素' },
  addRegArtic: { text: '発音' },
  addRegAccid: { text: '偶然' },
