...
export const lang = {
  ...
  addSupplied: { text: '選択された要素' },
  addSuppliedArticText: { text: '発音' },
  addSuppliedAccidText: { text: '偶然' },
  addUnclearText: { text: '<unclear>' },
  addUnclear: { text: '選択された要素' },
  addUnclearArticText: { text: '発音' },
  addUnclearAccidText: { text: '偶然' },
  addSicText: { text: '<sic>' },
  addSic: { text: '選択された要素' },
  addSicArticText: { text: '発音' },
  addSicAccidText: { text: '偶然' },
  addCorrText: { text: '<corr>' },
  addCorr: { text: '選択された要素' },
  addCorrArticText: { text: '発音' },
  addCorrAccidText: { text: '偶然' },
  addOrigText: { text: '<orig>' },
  addOrig: { text: '選択された要素' },
  addOrigArticText: { text: '発音' },
  addOrigAccidText: { text: '偶然' },
  addRegText: { text: '<reg>' },
  addReg: { text: '選択された要素' },
  addRegArticText: { text: '発音' },
  addRegAccidText: { text: '偶然' },
  addAddText: { text: '<add>' },
  addAdd: { text: '選択された要素' },
  addAddArticText: { text: '発音' },
  addAddAccidText: { text: '偶然' },
  addDelText: { text: '<del>' },
  addDel: { text: '選択された要素' },
  addDelArticText: { text: '発音' },
  addDelAccidText: { text: '偶然' },
