...
export const lang = {
  ...
  splashBody: {
    ...
    <p>
      Иако је mei-friend апликација заснована на прегледачу, ваши лични подаци (укључујући код који
      уређујете, поставке апликације и тренутне пријаве ако их има) се чувају у локалном складишту вашег прегледача
      <a href="https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage" target="_blank"
        >локалног складишта</a
      > и не шаљу се или не чувају на нашим серверима.
    </p>
    <p>
      Подаци се преносе на GitHub само када их изричито захтевате (нпр. када се пријавите на GitHub, учитате
      свој код из репозиторијума на GitHub-у или када захтевате GitHub акциони радни ток да се
      покрене за вас). Слично томе, подаци се преносе вашем одабраном Solid провајдеру само када их изричито
      захтевате (нпр. када се пријавите на Solid, учитате или сачувате стојне анотације).
    </p>
    <p>
