...
// att.visualOffset.ho (visual horizontal offset) (MEI 5.1)
export const attVisualOffsetHo = [
  accid,
  anchoredText,
  arpeg,
  artic,
...
// att.visualOffset.vo (visual vertical offset)
export const attVisualOffsetVo = [
  accid,
  anchoredText,
  arpeg,
  artic,
...
// att.visualOffset2.ho (pair of visual horizontal offsets, @startho, @endho)
export const attVisualOffset2Ho = [
  attacca,
  bend,
  bracketSpan,
  curve,
...
// att.visualOffset2.vo (pair of visual vertical offsets, @startvo, @endvo)
export const attVisualOffset2Vo = [bend, bracketSpan, curve, gliss, hairpin, line, lv, phrase, slur, tie];
