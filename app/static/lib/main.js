...
export let cmd = {
  ...
  shiftPitchNameUp: () => e.shiftPitchDiatonically(v, cm, 1),
  shiftPitchNameDown: () => e.shiftPitchDiatonically(v, cm, -1),
  shiftOctaveUp: () => e.shiftPitchDiatonically(v, cm, 7),
  shiftOctaveDown: () => e.shiftPitchDiatonically(v, cm, -7),
