...
export let cmd = {
  ...
  markNextNote: () => v.navigate(cm, 'note', 'forwards', true),
  markPreviousNote: () => v.navigate(cm, 'note', 'backwards', true),
  markNextMeasure: () => v.navigate(cm, 'measure', 'forwards', true),
  markPreviousMeasure: () => v.navigate(cm, 'measure', 'backwards', true),
  markLayerUp: () => v.navigate(cm, 'layer', 'upwards', true),
  markLayerDown: () => v.navigate(cm, 'layer', 'downwards', true),
