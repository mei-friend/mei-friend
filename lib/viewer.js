...
export default class Viewer {
  ...
  setVerovioOptions(newOptions = {}) {
    ...
    console.info('XXXX setVerovioOptions: ' + dimensions.width + '/' + dimensions.height);
  ...
  // when cursor position in editor has changed
  cursorActivity(e, cm) {
  ...
  // when editor emits changes
  notationUpdated(e, cm) {
    console.info('changes done: ', e);
