  ...
  setVerovioOptions(newOptions = {}) {
    ...
    if (this.vrvOptions.breaks !== "none") {
      this.vrvOptions.pageWidth = Math.max(Math.round(
        dimensions.width * (100 / this.vrvOptions.scale)), 400);
      this.vrvOptions.pageHeight = Math.max(Math.round(
        dimensions.height * (100 / this.vrvOptions.scale)), 200);
    }
    // this.vrvOptions.pageWidth = dimensions.width;
    // this.vrvOptions.pageHeight = dimensions.height;
