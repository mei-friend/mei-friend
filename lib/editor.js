...
export function addOctaveElement(v, cm, dis_place = 'above', dis = '8') {
  v.loadXml(cm.getValue());
  if (v.selectedElements.length < 1) return;
  ...
  findAndModifyOctaveElements(cm, v.xmlDoc, id1, id2, dis_place, dis);
