...
function workerEventsHandler(e) {
  ...
  switch (e.data.cmd) {
    ...
    case 'mei': // returned from importData, importBinaryData
      mei = e.data.msg;
      if (!v.speedMode) v.pageCount = e.data.pageCount;
      cm.setValue(mei);
      v.updateAll(cm, defaultOptions);
      break;
    case 'updated': // display SVG data on site
      ...
      document.querySelector('.verovio-panel').innerHTML = e.data.svg;
      if (e.data.setCursorToPageBeginning) v.setCursorToPageBeginning(cm);
      v.updatePageNumDisplay();
      v.addNotationEventListeners(cm);
      v.setNotationColors();
      v.updateHighlight(cm);
      if (!"setFocusToVerovioPane" in e.data || e.data.setFocusToVerovioPane)
...
let cmd = {
  ...
  'addSlur': () => addCtrlEl(v, cm, 'slur', ''),
  'addSlurBelow': () => addCtrlEl(v, cm, 'slur', 'below'),
  'addTie': () => addCtrlEl(v, cm, 'tie', ''),
  'addTieBelow': () => addCtrlEl(v, cm, 'tie', 'below'),
  'addCresHairpin': () => addCtrlEl(v, cm, 'hairpin', '', 'cres'),
  'addDimHairpin': () => addCtrlEl(v, cm, 'hairpin', '', 'dim'),
  'addCresHairpinBelow': () => addCtrlEl(v, cm, 'hairpin', 'below', 'cres'),
  'addDimHairpinBelow': () => addCtrlEl(v, cm, 'hairpin', 'below', 'dim'),
  'addFermata': () => addCtrlEl(v, cm, 'fermata', 'above', 'norm'),
  'addFermataBelow': () => addCtrlEl(v, cm, 'fermata', 'below', 'inv'),
  'addDirective': () => addCtrlEl(v, cm, 'dir', 'above', 'dolce'),
  'addDirectiveBelow': () => addCtrlEl(v, cm, 'dir', 'below', 'dolce'),
  'addDynamics': () => addCtrlEl(v, cm, 'dynam', 'above', 'mf'),
  'addDnamicsBelow': () => addCtrlEl(v, cm, 'dynam', 'below', 'mf'),
  'addTempo': () => addCtrlEl(v, cm, 'tempo', 'above', 'Allegro'),
  'addArpeggio': () => addCtrlEl(v, cm, 'arpeg'),
  'addGlissando': () => addCtrlEl(v, cm, 'gliss'),
  'addPedalDown': () => addCtrlEl(v, cm, 'pedal', 'down'),
  'addPedalUp': () => addCtrlEl(v, cm, 'pedal', 'up'),
  'addMordentAbove': () => addCtrlEl(v, cm, 'mordent', 'above', 'lower'),
  'addMordentBelow': () => addCtrlEl(v, cm, 'mordent', 'below', 'lower'),
  'addMordentAboveUpper': () => addCtrlEl(v, cm, 'mordent', 'above', 'upper'),
  'addMordentBelowUpper': () => addCtrlEl(v, cm, 'mordent', 'below', 'upper'),
  'addTrillAbove': () => addCtrlEl(v, cm, 'trill', 'above'),
  'addTrillBelow': () => addCtrlEl(v, cm, 'trill', 'below'),
  'addTurnAbove': () => addCtrlEl(v, cm, 'turn', 'above', 'upper'),
  'addTurnBelow': () => addCtrlEl(v, cm, 'turn', 'below', 'upper'),
  'addTurnAboveLower': () => addCtrlEl(v, cm, 'turn', 'above', 'lower'),
  'addTurnBelowLower': () => addCtrlEl(v, cm, 'turn', 'below', 'lower')
  // 'delete': () =>
};
